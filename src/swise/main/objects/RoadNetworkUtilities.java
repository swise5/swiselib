...
import swise.main.objects.AStar;
import swise.main.objects.NetworkUtilities;
...
public class RoadNetworkUtilities {
	 ...
	 */
	public static void connectToMajorNetwork(GeoNode n, GeoNetwork subNetwork, GeoNetwork roads) {
	 ...
	 */
	public static GeoNetwork extractMajorRoads(GeoNetwork roads){
		GeoNetwork majorRoads = new GeoNetwork();
